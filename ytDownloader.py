...
#        if meta['exists']:             
    ...
    def parse_json3_to_df(self,dump=True,subs_df_name='subs_df'):
        ...
        if dump:
            self.utils.dump_df(df=ytd.subs_df,fp=self.tmp_dir,name=subs_df_name)
...
if __name__=='__main__':
    ...
    isavailable, langs_d= ytd.check_available_subs_langs(lang='en')

    print(isavailable)
    ytd.download_subs(lang='en')                      # download vid 
